...
__maintainer__ = "Dhinesh Kumar Sundaram <dhinesh.gs@gmail.com>"
...
def make_cognito_blueprint(
    ...
    *,
    ...
    Args:
        ...
        state (str): The state parameter to include in the authorization request
        redirect_uri (str): The URL to redirect to after the cognito authentication is complete. defaults to url_for('cognito.authorized')
    ...
    cognito_bp = OAuth2ConsumerBlueprint(
        ...
        storage=storage,
        state=state,
        redirect_uri_func=redirect_uri_func,
    )
